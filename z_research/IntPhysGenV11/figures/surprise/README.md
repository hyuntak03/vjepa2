...
**다만 여기서 나온 사실 하나는 살린다** — **등가속·비가림**에서 `cylinder` 가 나머지 여섯에게
거의 다 이긴다 (cube 6%, capsule 0%, pyramid 12%). 짝평균(cube 83.3)은 그걸 가린다.
⚠️ **가림이 붙으면 오히려 완화된다** — 등가속+가림에서 cube→cylinder 는 43.8% 다.
그리고 최다 목적지 열 질량이 21~40%(균등 16.7%)라 **"한 물체로 몰린다" 로는 못 쓴다.**
정확한 진술은 `Archive/surprising_score/VOTE_GRID_2026-08-31.md` 를 볼 것.
